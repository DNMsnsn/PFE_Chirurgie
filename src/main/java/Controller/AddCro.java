...
@WebServlet("/AddCro")
public class AddCro extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(dao.create(c)) {
				...
				hs.setType_histo("ADD_CRO");
				hs.setDetails("Patient : " + np + " " + pp + " | Medecin " + no + " " + po);
				...
				request.setAttribute("error", "Protocole non Ajouter !");
